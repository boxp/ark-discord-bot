...
def get_config() -> Dict[str, Any]:
    ...
    config = {
        ...
        'kubernetes_namespace': os.getenv('KUBERNETES_NAMESPACE', 'ark-survival-ascended'),
        'kubernetes_deployment_name': os.getenv('KUBERNETES_DEPLOYMENT_NAME', 'ark-server'),
        'kubernetes_service_name': os.getenv('KUBERNETES_SERVICE_NAME', 'ark-server-service'),
